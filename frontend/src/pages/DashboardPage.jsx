...
function DashboardPage() {
  ...
  return (
    <section className="space-y-8">
      ...
      {/* AI Learning Intelligence Banner / Quick Hub */}
      <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6 text-white shadow-md">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-300 mt-1 max-w-xl">
              Upload study guides, PDFs, or lecture notes. Ask grounded questions with exact source citations or generate customized self-assessments.
            </p>
          </div>
          <div className="flex flex-wrap gap-3">
            <Link
              to="/ai/chat"
              className="inline-flex items-center gap-1.5 rounded-lg bg-blue-600 px-4 py-2.5 text-xs font-semibold text-white hover:bg-blue-500 transition-colors shadow-xs"
            >
              💬 Ask Documents
            </Link>
            <Link
              to="/ai/quizzes"
              className="inline-flex items-center gap-1.5 rounded-lg bg-white/10 hover:bg-white/20 border border-white/20 px-4 py-2.5 text-xs font-semibold text-white transition-colors"
            >
              ✨ Generate Quiz
            </Link>
            <Link
